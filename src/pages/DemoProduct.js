...
//     useEffect(() => {
//         document.title = 'Obliqware | Demo our products';
//     }, []);
...
//                                     value="banking_chatbot_solutions" onChange={handleChange}
//                                 />
//                                 <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Banking Chatbot Solutions</label>
//                             </div>
//                             <div className="flex items-center my-4">
//                                 <input
//                                     id="checkbox-1"
...
//                                     type="checkbox"
//                                     className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
//                                     value="international_tax_chatbot" onChange={handleChange}
//                                 />
//                                 <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">International Tax Chatbot</label>
//                             </div>
//                             <div className="flex items-center my-4">
//                                 <input
//                                     id="checkbox-1"
...
//                                     type="checkbox"
//                                     className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
//                                     value="automation_scraping_tools" onChange={handleChange}
//                                 />
//                                 <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Automation & Scraping Tools</label>
//                             </div>
//                             <div className="flex items-center my-4">
//                                 <input
//                                     id="checkbox-1"
...
//                                     type="checkbox"
//                                     className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
//                                     value="food_delivery_app_clone" onChange={handleChange}
//                                 />
//                                 <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Food Delivery App (Clone)</label>
//                             </div>
//                             {errors &&
...
//                                     <a href={hrefMapLink} className="text-gray-400">Karachi, Pakistan</a>
//                                 </div>
//                             </div>
...
const DemoProduct = (props) => {
    ...
    //     fData.append('phone_number', phone);
    //     fData.append('message', message);
    //     fData.append('products', demoProducts.join(',')); // Join array to send as string
    ...
    //     axios({
    //         method: 'post',
    //         url: 'https://obliqware-website-demo-product-api.onrender.com', // Replace with your actual API URL
    //         data: fData,
    //         headers: {
    //             'Content-Type': 'multipart/form-data',
    //         },
    ...
    async function sendEmail(e) {
        ...
        try {
            ...
            if (response && response.status === 500) {
                ...
                Notiflix.Report.failure('An unexpected error occurred', 'Please try again later.', 'Okay');
            }
        } finally {
            document.getElementById('submitBtn').disabled = false;
            document.getElementById('submitBtn').innerHTML = 'Send Message';
                        ...
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            ...
                            <div className="flex items-center my-4">
                                <input
                                    ...
                                    type="checkbox"
                                    className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
                                    value="banking_chatbot_solutions"
                            ...
                            <div className="flex items-center my-4">
                                <input
                                    ...
                                    type="checkbox"
                                    className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
                                    value="international_tax_chatbot"
                                    onChange={handleChange}
                                />
                                <label htmlFor="checkbox-2" className="ml-3 text-lg font-medium text-gray-900">International Tax Chatbot</label>
                            </div>
                            <div className="flex items-center my-4">
                                <input
                                    id="checkbox-3"
                                    type="checkbox"
                                    className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
                                    value="automation_scraping_tools"
                                    onChange={handleChange}
                                />
                                <label htmlFor="checkbox-3" className="ml-3 text-lg font-medium text-gray-900">Automation & Scraping Tools</label>
                            </div>
                            <div className="flex items-center my-4">
                                <input
                                    id="checkbox-4"
                                    type="checkbox"
                                    className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
                                    value="food_delivery_app_clone"
                                    onChange={handleChange}
                                />
                                <label htmlFor="checkbox-4" className="ml-3 text-lg font-medium text-gray-900">Food Delivery App (Clone)</label>
                            </div>
