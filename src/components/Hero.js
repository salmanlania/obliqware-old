                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            <h1 className="mb-5 md:text-5xl text-3xl font-bold text-blue-900">
                                ...
                                Tailored software to boost your business—mobile apps, web solutions, and AI.
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">We are a passionate team of skilled developers, committed to delivering top-notch software that meets your highest standards.</div>
